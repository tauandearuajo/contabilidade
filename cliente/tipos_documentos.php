...
$consulta_blog = "SELECT * FROM document_type";
...
$result_blog = "SELECT * FROM document_type ORDER BY name asc limit $incio, $quantidade_pg";
    ...
    <div class='modal  fade' id='cadastroAgent' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
        <div class='modal-dialog'>
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    <form action='model/add_type_document.php' method='post' enctype="multipart/form-data">
                        <div class='row '>
                         <!--   <div class='col-lg-12'>
                                <div class='form-group'>
                            ...
                            <div class='col-lg-12'>
                                <div class='form-group'>
                                    <label class='form-label' for='fName'>Nome do tipo de documento</label>
                                    <input type="text" class='form-control' name="name_typedocument" id="name_typedocument">
                                </div>
                            </div>
