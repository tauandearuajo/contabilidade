...
$consulta_blog = "SELECT * FROM fees";
...
$result_blog = "SELECT * FROM fees ORDER BY name desc limit $incio, $quantidade_pg";
            ...
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="iq-filemanger-page">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link active" aria-current="page" href="honorarios.php">
                            <i class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                                    <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" />
                                </svg>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header mb-4 mt-1" style="border-radius: 25px;">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Honorarios</h4>
                                </div>
                            </div>
        ...
        <div class='modal-dialog'>
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    <form action='model/add_honorario.php' method='post' enctype="multipart/form-data">
                        <div class='row '>
                            <div class='col-lg-12'>
                            ...
                            <div class='col-lg-6'>
                                <div class='form-group'>
                                    <label class='form-label' for='fName'>Valor do honorario</label>
