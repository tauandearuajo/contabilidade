...
<body class="">
                ...
                <div class="sidebar-profile-body">
                    <div class="mb-3 d-flex justify-content-center">
                        <div class="rounded rounded-3  border-primary p-2">
                            <img src="<?php echo $dadosUser['photo_user'] ?>" alt="User-Profile"
                                class="img-fluid rounded-circle" style="border: 4px solid #F5773D;" loading="lazy">
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header mb-4 mt-1" style="border-radius: 25px;">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Guias e documentos</h4>
                                </div>
                                <div class="col-md-3 d-flex justify-content-end">
                                    <a class='btn btn-primary rounded-pill' data-bs-toggle="modal"
                                        data-bs-target="#cadastroAgent"><svg xmlns="http://www.w3.org/2000/svg"
                                            width="16" height="16" fill="currentColor" class="bi bi-cloud-download-fill"
                                            viewBox="0 0 16 16">
                                ...
                                <div class="col-md-3 d-flex justify-content-end">
                                    <a class='btn btn-primary rounded-pill' href="tipos_documentos.php"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-cloud-download-fill" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd"
                                                d="M8 0a5.53 5.53 0 0 0-3.594 1.342c-.766.66-1.321 1.52-1.464 2.383C1.266 4.095 0 5.555 0 7.318 0 9.366 1.708 11 3.781 11H7.5V5.5a.5.5 0 0 1 1 0V11h4.188C14.502 11 16 9.57 16 7.773c0-1.636-1.242-2.969-2.834-3.194C12.923 1.999 10.69 0 8 0m-.354 15.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 14.293V11h-1v3.293l-2.146-2.147a.5.5 0 0 0-.708.708z" />
                                        </svg> Tipos de documentos</a>
                                </div>
                            </div>
        ...
        <footer class="footer">
            <div class="footer-body">
                <ul class="left-panel list-inline mb-0 p-0">
                    <li class="list-inline-item"><a href="dashboard/extra/privacy-policy.html">Politicas de
                            privacidade</a></li>
    ...
    <div class='modal  fade' id='cadastroAgent' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1'
        ...
        <div class='modal-dialog'>
            <div class='modal-content'>
                <div class='modal-header bg-primary' style='border:none;'>
                    ...
                    <button type='button' class='btn-close rounded-circle bg-danger' data-bs-dismiss='modal'
